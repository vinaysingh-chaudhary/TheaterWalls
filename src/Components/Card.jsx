...
function Card({img, id, title, rating, release,genre, naviFunc, media,}) {
  ...
  return (
    <div className='min-w-[150px] h-[90%] border-red-900 border-2 relative' onClick={() => naviFunc(media === "movie" ? "movie" : "tv", id)}>
 
      <LazyLoadImage className='w-[100%] h-[100%] object-cover' src={img} alt="" />
      ...
      <div className='flex flex-row text-[1rem]'>
        {/* fix genreStamp CSS in Genre Stamp Component */}
