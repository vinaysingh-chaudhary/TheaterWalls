...
const HeroBanner = () => {
  ...
  return (
    <div className=" relative w-full h-[25%] bg-black">
      ...
      <div className="absolute top-0 w-full h-[100%] bg-gradient-to-b from-[#00000024] to-[#000000]"></div>

      <div>
        <div className="w-[70%] h-[55px]  sm:w-[60%] md:w-[55%] lg:w-[40%] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex justify-between rounded-md p-1 bg-[#17171750]">
          <input
            type="text"
