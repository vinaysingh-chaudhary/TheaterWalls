...
const ExplorePage = () => {
  ...
  const fetchNextData = () =>{
    setLoading(true);
    fetchApi( `/discover/${mediaType}?page=${pageNum}`, filter).then((response)=> {
        if(response?.results){
          setData({
  ...
  return (
    <div className="w-[100%] h-[100%] flex flex-col">
      <div className="w-[100%] h-[10vh] flex flex-col justify-evenly items-center">
      ...
      (
        ...
        className="w-[100vw] h-[100vh] flex flex-row flex-wrap justify-around gap-y-2 overflow-y-auto  pt-2">
